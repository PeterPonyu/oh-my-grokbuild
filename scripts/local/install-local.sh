...
log "  4. For live Grok reachability: OMGB_E2E_HEADLESS=1 scripts/local/e2e.sh"
log "  5. To prove /omgb itself: OMGB_E2E_HEADLESS=1 OMGB_E2E_REAL_OMGB=1 scripts/local/e2e.sh"
log "  6. Or run: npm run e2e:real-omgb"
log "  7. Inside Grok: /omgb <your task>"
log "  8. After a run: ./scripts/workflow/export-omgb-handoff.sh <slug>  (share to Claude/Codex/etc.)"
log "  9. See docs/WORKING-WITH-OTHER-AGENTS.md for hybrid team instructions"
