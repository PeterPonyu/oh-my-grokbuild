...
- `node scripts/validate.mjs --smoke` and `--sanity` both report `[OMGB] ... passed`.
- `npm test` passes.
- `scripts/e2e.sh` passes (or documented why skipped).
...
**Handoff generated by:** `scripts/export-omgb-handoff.sh`
